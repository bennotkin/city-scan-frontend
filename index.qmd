...
city_dir <- paste0("mnt/", readLines("city-dir.txt"), "/")
user_input_dir <- paste0(city_dir, "01-user-input/")
process_output_dir <- paste0(city_dir, "02-process-output/")
spatial_dir <- paste0(process_output_dir, "spatial/")
output_dir <- paste0(city_dir, "03-render-output/")
styled_maps_dir <- "styled-maps/"

# City parameters
city_params <- read_yaml(paste0(user_input_dir, "city_inputs.yml"))
...
# Define the AOI
aoi <- st_read(paste0(user_input_dir, "AOI"))
...
# Read RWI
rwi <-
  st_read(paste0(spatial_dir, "relative_wealth_index"), quiet = T) %>%
...
# rwi <- vect(paste0(spatial_dir, "relative_wealth_index"))
